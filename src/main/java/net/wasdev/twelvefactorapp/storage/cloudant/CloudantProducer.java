...
import net.wasdev.twelvefactorapp.bluemix.InvalidCredentialsException;
import net.wasdev.twelvefactorapp.bluemix.ServiceName;
import net.wasdev.twelvefactorapp.bluemix.VCAPServices;
...
public class CloudantProducer {
    ...
    public CloudantClient expose(InjectionPoint ip) throws InvalidCredentialsException {
        ...
        System.out.println("Connecting to Cloudant client with credentials, url:" + credentials.getUrl() + " username:" + credentials.getUsername());
